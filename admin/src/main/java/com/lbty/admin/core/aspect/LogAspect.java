package com.lbty.admin.core.aspect;
...
import com.lbty.admin.common.util.IPUtils;
import com.lbty.admin.security.util.SecurityUtils;
import com.lbty.admin.system.model.entity.Log;
import com.lbty.admin.system.service.LogService;
...
public class LogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.lbty.admin.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.lbty.admin.common.annotation.Log logAnnotation, long executionTime, Long userId) {
